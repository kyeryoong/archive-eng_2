  ...
  return (
    <div className={styles.container}>
      <div className={styles.containerTop}>
        <div className={styles.title1}>온라인 시험 플랫폼</div>

        <div className={styles.title2}>테스트콘</div>
      ...
      <div className={styles.containerBottom}>
        <div className={styles.infoContainer} ref={ref1}>
          ...
          <Paragraph>
            오늘날 종이보다는 PDF나 워드 파일, 두꺼운 책보다는 얇은 태블릿으로
            공부하는 사람들이 많아지고 있습니다. 그리고, 컴퓨터로 시험을
            보는(CBT Computer-Based Test) 경우를 심심치 않게 발견할 수 있습니다.
            예를 들자면, 2023년부터 한국산업인력공단이 주관하는 기사 시험 같은
            경우, 필기를 CBT 방식으로 전환하여 시행하고 있습니다. 그리고,
            코로나19로 인해 많은 대학교에서 온라인 시험 플랫폼을 활용하여 시험을
            진행하는 경우를 많이 볼 수 있었습니다. 취업 준비생들에게 친숙한 AI
            온라인 역량검사나 코딩 테스트도 모두 컴퓨터로 진행됩니다. 이처럼
            온라인으로 시험을 보는 시대가 도래한 만큼, 개인 프로젝트로 온라인
            시험 플랫폼 테스트콘을 제작하게 되었습니다.
          </Paragraph>
        </div>
