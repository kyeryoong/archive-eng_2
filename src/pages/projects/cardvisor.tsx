...
export default function Cardvisor() {
  ...
  let refPositions: number[] = [
    ...
    ref4.current?.getBoundingClientRect().top !== undefined
      ...
      : 0,
    ref5.current?.getBoundingClientRect().top !== undefined
      ? Math.abs(ref5.current?.getBoundingClientRect().top)
      : 0,
    ref6.current?.getBoundingClientRect().top !== undefined
      ? Math.abs(ref6.current?.getBoundingClientRect().top)
      : 0,
    ref7.current?.getBoundingClientRect().top !== undefined
      ? Math.abs(ref7.current?.getBoundingClientRect().top)
      : 0,
  ];
  ...
  return (
    <div className={styles.container}>
      <div className={styles.containerTop}>
        ...
        <div className={styles.title2}>카드바이저</div>
      ...
      <div className={styles.containerBottom}>
        <div className={styles.infoContainer} ref={ref1}>
          ...
          <Paragraph>
            대한민국은 연간 카드 승인 금액이 약 200조원이 넘을 만큼, 카드
            사용량이 많은 나라입니다. 사용자 본인에게 적합한 카드를
            사용하게되면, 효율적인 경제 활동을 할 수 있습니다. 그래서, 우리팀은
            소비자들이 자신이 원하는 혜택과 브랜드를 선택하여 가장 적합한 카드를
            추천해주는 서비스를 개발하였습니다.
          </Paragraph>
        </div>
        ...
        <div className={styles.infoContainer} ref={ref2}>
          ...
          <div className={styles.memberContainer}>
            <Member
              name="김민석"
              id="min-0404"
              position="Team Leader, Back-End Programmer"
              url={78293352}
            />
            <Member
              name="조융"
        ...
        <div className={styles.infoContainer} ref={ref3}>
          ...
          <div className={styles.achievementContainer}>
            ...
            <Paragraph>마이 핀테크 서비스 해커톤 - 우수상(학생부)</Paragraph>

            <Paragraph>졸업 전시회 기간 약 300명 소프트웨어 체험</Paragraph>
        ...
        <div className={styles.infoContainer} ref={ref4}>
          ...
          <div className={styles.repositoryContainer}>
            <Repository
              name="프론트 엔드 GitHub 페이지"
              url="/kyeryoong/cardvisor"
            />
            <Repository
              name="백 엔드 GitHub 페이지"
              url="/min-0404/Graduation_Project"
            />
          </div>
        </div>
        ...
        <div className={styles.infoContainer} ref={ref5}>
          ...
          <div className={styles.techContainer}>
            <div className={styles.techHeader}>백 엔드</div>
          ...
          <div className={styles.techContainer}>
            <div className={styles.techHeader}>데이터 수집 & 분석</div>
          ...
          <div className={styles.techContainer}>
            <div className={styles.techHeader}>추천 알고리즘</div>
          ...
          <div className={styles.techContainer}>
            <div className={styles.techHeader}>협업 & 버전 관리</div>
              ...
              (elem: string, index: number) => (
                <SwiperSlide key={index}>
                  <Image
                    width={2100}
                    height={1200}
                    src={`/projects/cardvisor/${elem}.png`}
                    alt=""
