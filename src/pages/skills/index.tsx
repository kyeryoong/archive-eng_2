...
export default function Skills() {
  return (
    <div className={styles.container}>
      <div className={styles.skillsHeader}>Web Development</div>
      ...
      <div className={styles.skillsHeader}>Deploy</div>
      ...
      <div className={styles.skillsHeader}>Cloud</div>
      ...
      <div className={styles.skillsHeader}>Database</div>
      ...
      <div className={styles.skillsHeader}>Version Control</div>
