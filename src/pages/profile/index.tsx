  ...
  return (
    <div className={styles.equipmentElements}>
      <Image
        ...
        src={"/profile/equipment" + index + ".png"}
      />

      <div className={styles.equipmentText}>{text}</div>

      <div className={styles.equipmentSubText}>{subText}</div>
    </div>
  );
}
    ...
    <div className={styles.container}>
      <div>
        ...
        >
              ...
              <div className={styles.profile}>
                <div className={styles.profileContainer}>
                  <div className={styles.imageContainer}>
                    <Image
                      className={
                        imageIndex === 0 ? styles.image1Show : styles.image1Hide
                      }
                      alt=""
                    ...
                    <Image
                      className={
                        imageIndex === 1 ? styles.image2Show : styles.image2Hide
                      }
                      alt=""
                  ...
                  <div className={styles.textWrapper}>
                    <div className={styles.textNormal}>안녕하세요,</div>
                    ...
                    <div className={styles.textNormal}>김영우 입니다.</div>
                  </div>
                </div>
          ...
          <SwiperSlide>
            <div className={styles.page}>
              <div className={styles.question}>컴퓨터공학과를 선택한 이유</div>

              <div className={styles.line} />

              <div className={styles.answer}>
                저는 어릴 적부터 컴퓨터에 대한 관심이 많았습니다.
                <br />
                항상 컴퓨터를 가지고 무언가를 하고 있었고, 프로그램을 잘못
                건드려서 컴퓨터가 이상해질 때도 많았습니다.
                <br />
                아르바이트할 때, 컴퓨터 앞에서 문서를 정리했었고,
                <br />군 복무 중일 때도, 컴퓨터로 기상 관련 정보를 입력하는
                업무를 수행했습니다.
              </div>
          ...
          <SwiperSlide>
            <div className={styles.page}>
              ...
              <div className={styles.answer}>
                직접 눈으로 보여지는 화면을 만드는 것이 너무 즐거웠습니다.
                <br />
                특히, 내가 작성한 코드가 바로 브라우저에 나타나는 것이
                좋았습니다.
              </div>
          ...
          <SwiperSlide>
            <div className={styles.page}>
              ...
              <div className={styles.keyFactorContainer}>
                <div className={styles.keyFactor}>새로운 것 배우기</div>

                <div className={styles.keyFactor}>다른 사람의 말 경청하기</div>

                <div className={styles.keyFactor}>
                  다른 팀원의 분야 이해하기
                </div>

                <div className={styles.keyFactor}>스스로 문제를 해결하기</div>

                <div className={styles.keyFactor}>다른 사람의 코드 잘 읽기</div>

                <div className={styles.keyFactor}>구글링 잘 하기</div>

                <div className={styles.keyFactor}>영어 문서 잘 읽기</div>
              </div>
            </div>
          </SwiperSlide>
